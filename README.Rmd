...
The most basic version of this script is simply for building a histogram with only *one* group type defined out of the two that are possible. No statistics were run on this data and the individual data scatter is not beind displayed.
