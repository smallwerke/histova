...
**The following images are the default output from RStudio, the saved versions from the script have complete font embedding and higher resoltion.**

### Two Groups



This is an old basic example of an early version of the script with minimal options.
