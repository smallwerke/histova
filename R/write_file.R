...
#Colors Specific	G2, #606060, #FFD700, 2, 3.8
#Colors Specific	G3, #00c000, #000000, 1, 1.6
#Colors Specific	G4, #f71480, #606060, 5, 1.6
#Colors Specific	G5, #0000ff, #606060, 6, 2.6
#Colors Specific	G6, #ff0000, #606060, 7, 5.6
#Colors Alpha	0.6
#Scatter Alpha	0.8
#Scatter ColorShapeSize	UNIQUE
#Scatter Stroke	1
...
#Title Main	1 Group Test
#X Leg	Basic Figure<br>*differing scatter shapes & sizes*
#Y Leg	&micro; values
